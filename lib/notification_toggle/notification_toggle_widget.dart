...
import 'notification_toggle_model.dart';
export 'notification_toggle_model.dart';
...
class _NotificationToggleWidgetState extends State<NotificationToggleWidget> {
  late NotificationToggleModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NotificationToggleModel());
