...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    dupnoGPSProAuthUserSubject.add(
      DupnoGPSProAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<DupnoGPSProAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  DupnoGPSProAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = DupnoGPSProAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    dupnoGPSProAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
DupnoGPSProAuthUser? currentUser;
